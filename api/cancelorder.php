...
$famt=mysql_query("SELECT * FROM `order_details` WHERE `order_id` ='$oid' ");
...
if($difd>=+14) //if order is of one month
{
	...
	if($ded_amount_days<=5)
	{
		...
		echo "Order Cancel successfully And Credited Amount To Your Account.. ";
		exit();
	}
